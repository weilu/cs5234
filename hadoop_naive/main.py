...
def main(argv):
	...
	os.system('hdfs dfs -mkdir /user/hduser/'+filename+timestamp+'/temp/graph.temp > local.log')
	os.system('hdfs dfs -put -f'+' '+filepath+' '+'/user/hduser/'+filename+timestamp+'/temp/graph.temp/part-00000 > local.log')
	...
	print()
	print('(Naive) Elapsed Time', elapsed_time)
	print('Results:')
